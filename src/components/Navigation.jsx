                         ...
                         <div className="w-96">
                              <form>
                                   ...
                                   <div className="relative ">
                                        <input type="text" id="default-search" className="block pl-4 pr-8 md:w-96 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-gray-500 focus:border-gray-500 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-300 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Cari mobil, motor, handphone, dan lainnya..." required="" onKeyDown={(e) => { e.key === 'Enter' && e.preventDefault() }} onChange={handleSearchInputChange} />
