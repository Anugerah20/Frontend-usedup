               ...
               <form className="w-full flex flex-wrap">
                    <div className="w-full sm:w-1/2">
                         ...
                         <div className="mb-2">
                              ...
                              <textarea name="deksripsiIklan" id="deksripsiIklan" cols="0" rows="4" className="flex border-2 border-gray-200 outline-none focus:border-2 mt-2 w-[260px] rounded-none"></textarea>
                         </div>
